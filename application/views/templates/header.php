...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-nav navbar-left navbar-top-links">
            <li><a href="<?php echo base_url(); ?>"><i class="fa fa-home fa-fw"></i> Codeigniter admin Panel</a></li>
        </ul>
        ...
        <ul class="nav navbar-right navbar-top-links">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li><a href="<?php echo base_url(); ?>users/edit"><i class="fa fa-gear fa-fw"></i> Settings</a>
                    </li>
                    <li class="divider"></li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="active"><i class="fa fa-rss-square fa-fw"></i> Posts</a>
                    ...
                    <li>
                        <a href="#" class="active"><i class="fa fa-file-powerpoint-o fa-fw"></i> Project</a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#" class="active"><i class="fa fa-tasks fa-fw"></i> Task</a>
                        <ul class="nav nav-second-level">
                            <li>
